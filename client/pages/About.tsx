    ...
    <div>
      ...
      <section className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          <img src="https://images.unsplash.com/photo-1556306535-abccb1f69f3e?q=80&auto=format&fit=crop&w=1000" alt="Swatches" className="h-48 w-full rounded-lg object-cover md:h-full" />
          <img src="https://images.unsplash.com/photo-1516826957135-700dedea698c?q=80&auto=format&fit=crop&w=1000" alt="Workshop" className="h-48 w-full rounded-lg object-cover md:h-full" />
          <img src="https://images.unsplash.com/photo-1551024601-bec78aea704b?q=80&auto=format&fit=crop&w=1000" alt="Knit" className="h-48 w-full rounded-lg object-cover md:h-full" />
          <img src="https://images.unsplash.com/photo-1542060748-10c28b62716b?q=80&auto=format&fit=crop&w=1000" alt="Outerwear" className="h-48 w-full rounded-lg object-cover md:h-full" />
        </div>
      </section>
    </div>
  );
