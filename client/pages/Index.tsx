    ...
    <div>
      ...
      <section className="relative">
        ...
        <div className="container relative z-10 mx-auto flex h-[60vh] items-end px-4 pb-12 sm:h-[70vh]">
          <div className="max-w-xl text-white">
            ...
            <p className="mt-3 text-white/80">Minimal design meets performance fabrics. Build a wardrobe that works as hard as you do.</p>
            <div className="mt-6 flex flex-wrap gap-3">
              <Button size="lg" className="">Shop New Arrivals</Button>
        ...
        <div className="container mx-auto grid grid-cols-1 gap-6 px-4 py-8 sm:grid-cols-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">On US orders over $75</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="h-8 w-8 rounded-full bg-primary/10" />
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex items-end justify-between">
          ...
          <Button variant="ghost" className="hidden text-sm md:inline-flex">View all</Button>
        </div>
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          {[
            { title: "Outerwear", img: "https://images.unsplash.com/photo-1520975661595-6453be3f7070?q=80&w=1400&auto=format&fit=crop" },
            { title: "Tops", img: "https://images.unsplash.com/photo-1516826957135-700dedea698c?q=80&w=1400&auto=format&fit=crop" },
            { title: "Bottoms", img: "https://images.unsplash.com/photo-1519744792095-2f2205e87b6f?q=80&w=1400&auto=format&fit=crop" },
          ].map((c) => (
            <div key={c.title} className="group relative overflow-hidden rounded-2xl border">
              <img src={c.img} alt={c.title} className="aspect-[16/10] w-full object-cover transition duration-500 group-hover:scale-105" />
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex items-end justify-between">
          ...
          <Button variant="ghost" className="hidden text-sm md:inline-flex">View collection</Button>
        </div>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="overflow-hidden rounded-2xl border bg-card p-8 md:p-12">
          <p className="text-sm font-semibold text-primary">What customers say</p>
          <blockquote className="mt-3 text-2xl font-medium leading-snug tracking-tight">
            “The only brand I wear to the office and the gym. The fit and fabric are unmatched.”
          </blockquote>
          <p className="mt-3 text-sm text-muted-foreground">— Alex P., New York</p>
        </div>
      </section>
