    ...
    <footer className="border-t bg-white dark:bg-background">
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground max-w-sm">
              Contemporary menswear crafted for movement. Premium fabrics, clean lines, and timeless design.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/shop" className="hover:text-foreground">Tops</Link></li>
              <li><Link to="/shop" className="hover:text-foreground">Bottoms</Link></li>
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-muted-foreground">Sign up for 10% off your first order and product drops.</p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-6 text-xs text-muted-foreground md:flex-row">
          <p>© {new Date().getFullYear()} Forge & Thread. All rights reserved.</p>
